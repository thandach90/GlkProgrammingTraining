...
namespace Problems
{
    public static class BasicProgramming
    {
        ...
        /// <summary>
        /// We have two cats, a and b, and the parameters aYawn and aYawn indicate if each is yawning. We are in trouble if they are both yawning or if neither of them is yawning. Return true if we are in trouble.
        /// </summary>
